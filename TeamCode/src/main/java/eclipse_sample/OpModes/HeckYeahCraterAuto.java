...
public class HeckYeahCraterAuto extends LinearOpMode {
    @Override
    public void runOpMode() throws InterruptedException {
        ...
        if (opModeIsActive()) {
            arm.joint1.setAngle(60);
            arm.joint2.setRelativeAngle(-110);
            arm.joint3.setRelativeAngle(0);
            arm.joint4.setRelativeAngle(40);
            arm.disable();
            ...
            switch (Position) {
                ...
                default:
                    ...
                    arm.joint1.setAngle(35);
                    Thread.sleep(1000);
                    arm.intake.stopper();
                    arm.joint2.motor.setMotorEnable();
                    arm.joint1.setAngle(45);
                    arm.joint2.setRelativeAngle(80);
                    arm.joint3.setRelativeAngle(40);
                    arm.joint4.setRelativeAngle(-120);
                    arm.joint1.setPower(.25);
                    arm.joint2.setPower(.35);
                    arm.joint3.setPower(.6);
                    arm.joint4.setPower(.6);
                    arm.intake.outtaker();
                    Thread.sleep(200);
                    arm.intake.stopper();
                    drivetrain.moveInches(8, movePower);
                    drivetrain.pidTurn(turnPower, -20);
                    Thread.sleep(1000);
                    arm.joint4.setRelativeAngle(-70);
                    arm.intake.intaker();
                    Thread.sleep(1600);
                    arm.intake.stopper();
                    arm.joint1.setAngle(-29);
                    arm.joint2.setRelativeAngle(171);
                    arm.joint3.setRelativeAngle(-164);
                    arm.joint4.setRelativeAngle(125);
                    arm.joint1.setPower(.2);
                    arm.joint2.setPower(.5);
                    ...
                    lift.setServo(1);
                    drivetrain.turnFromPosition(turnPower, 5);
                    drivetrain.moveInches(620, movePower);
                    lift.setServo(1);
                    break;
            }
