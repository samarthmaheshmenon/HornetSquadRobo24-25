...
public class SimplerScoringArm {
    ...
    private double tolerance1 = 15;
    private double tolerance2 = 15;
    private double tolerance3 = 20;
    ...
    public SimplerScoringArm(LinearOpMode l, DcMotor.ZeroPowerBehavior zeroPowerBehavior){
        linearOpMode = l;
    ...
    {
        if(joint1.one.getTargetPosition() + tolerance1 > joint1.one.getCurrentPosition() && joint1.two.getTargetPosition() - tolerance1 < joint1.one.getCurrentPosition()){
